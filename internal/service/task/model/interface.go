...
type Service interface {
	...
	UpdateTask(ctx context.Context, task *UpdateTask) error
	UpdateTaskWorkflow(ctx workflow.Context, input *UpdateTask) error
	UpdateTaskActivity(ctx context.Context, input *UpdateTask) error
}
